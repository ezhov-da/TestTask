 ...
 * @version 1.0
 */
public class EntryDaoException extends Exception {
	/**
	 * Создает <code>EntryDaoException</code> с указанным
	 * детализирующим сообщением.
	 *
	 * @param message детализирующее сообщение.
	 */
	public EntryDaoException(String message) {
		super(message);
	}
	 ...
	 */
	public EntryDaoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *              что причина несуществует или неизвестна.)
	 */
	public EntryDaoException(Throwable cause) {
		super(cause);
	}
}