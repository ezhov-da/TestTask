 ...
 * @version 1.0
 */
public class EntryServiceException extends Exception {
	/**
	 * Создает <code>EntryServiceException</code> с указанным
	 * детализирующим сообщением.
	 *
	 * @param message детализирующее сообщение.
	 */
	public EntryServiceException(String message) {
		super(message);
	}
	 ...
	 */
	public EntryServiceException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *              что причина несуществует или неизвестна.)
	 */
	public EntryServiceException(Throwable cause) {
		super(cause);
	}
}